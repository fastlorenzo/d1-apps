...
output_dir = os.path.join(current_dir, "..", "..", "instances", instance_name)
...
# Get all files from the templates directory, recursively
files = []
for root, _, filenames in os.walk(templates_dir):
    for filename in filenames:
        files.append(os.path.relpath(os.path.join(root, filename), templates_dir))
